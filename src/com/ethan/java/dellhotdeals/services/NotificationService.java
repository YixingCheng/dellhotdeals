...
public class NotificationService {
	 ...
	 */
	public void notifyUser(String email, String uri, HashMap<String, String> update) {
        Properties props = new Properties();
        Session session = Session.getDefaultInstance(props, null);
        session.setDebug(true);
        
        String msgBody = "The webpage " + uri + " has changed!\n";
        msgBody = msgBody + update.size() + " deal(s) have been added!\n";
        msgBody += "They are: \n";
        for(String deal: update.keySet()){
        	msgBody = msgBody + "   " + deal + ": " + update.get(deal) + "\n"; 
        }
